...
public class PaymentRemainingActivity extends Activity {
    Profile myProfile;
   ...
   public boolean shouldOverrideUrlLoading(WebView view, String url) {
    ...
    return false;
        ...
        mapParams.put("hash",PaymentRemainingActivity.this.hash);
        mapParams.put("txnid",(empty(PaymentRemainingActivity.this.params.get("txnid"))) ? "" : PaymentRemainingActivity.this.params.get("txnid"));
        Log.d(tag, "txnid: "+PaymentRemainingActivity.this.params.get("txnid"));
        mapParams.put("service_provider","payu_paisa");

        mapParams.put("amount",(empty(PaymentRemainingActivity.this.params.get("amount"))) ? "" : PaymentRemainingActivity.this.params.get("amount"));
        mapParams.put("firstname",(empty(PaymentRemainingActivity.this.params.get("firstname"))) ? "" : PaymentRemainingActivity.this.params.get("firstname"));
        mapParams.put("email",(empty(PaymentRemainingActivity.this.params.get("email"))) ? "" : PaymentRemainingActivity.this.params.get("email"));
        mapParams.put("phone",(empty(PaymentRemainingActivity.this.params.get("phone"))) ? "" : PaymentRemainingActivity.this.params.get("phone"));

        mapParams.put("productinfo",(empty(PaymentRemainingActivity.this.params.get("productinfo"))) ? "" : PaymentRemainingActivity.this.params.get("productinfo"));
        mapParams.put("surl",(empty(PaymentRemainingActivity.this.params.get("surl"))) ? "" : PaymentRemainingActivity.this.params.get("surl"));
        mapParams.put("furl",(empty(PaymentRemainingActivity.this.params.get("furl"))) ? "" : PaymentRemainingActivity.this.params.get("furl"));
        mapParams.put("lastname",(empty(PaymentRemainingActivity.this.params.get("lastname"))) ? "" : PaymentRemainingActivity.this.params.get("lastname"));

        mapParams.put("address1",(empty(PaymentRemainingActivity.this.params.get("address1"))) ? "" : PaymentRemainingActivity.this.params.get("address1"));
        mapParams.put("address2",(empty(PaymentRemainingActivity.this.params.get("address2"))) ? "" : PaymentRemainingActivity.this.params.get("address2"));
        mapParams.put("city",(empty(PaymentRemainingActivity.this.params.get("city"))) ? "" : PaymentRemainingActivity.this.params.get("city"));
        mapParams.put("state",(empty(PaymentRemainingActivity.this.params.get("state"))) ? "" : PaymentRemainingActivity.this.params.get("state"));

        mapParams.put("country",(empty(PaymentRemainingActivity.this.params.get("country"))) ? "" : PaymentRemainingActivity.this.params.get("country"));
        mapParams.put("zipcode",(empty(PaymentRemainingActivity.this.params.get("zipcode"))) ? "" : PaymentRemainingActivity.this.params.get("zipcode"));
        mapParams.put("udf1",(empty(PaymentRemainingActivity.this.params.get("udf1"))) ? "" : PaymentRemainingActivity.this.params.get("udf1"));
        mapParams.put("udf2",(empty(PaymentRemainingActivity.this.params.get("udf2"))) ? "" : PaymentRemainingActivity.this.params.get("udf2"));

        mapParams.put("udf3",(empty(PaymentRemainingActivity.this.params.get("udf3"))) ? "" : PaymentRemainingActivity.this.params.get("udf3"));
        mapParams.put("udf4",(empty(PaymentRemainingActivity.this.params.get("udf4"))) ? "" : PaymentRemainingActivity.this.params.get("udf4"));
        mapParams.put("udf5",(empty(PaymentRemainingActivity.this.params.get("udf5"))) ? "" : PaymentRemainingActivity.this.params.get("udf5"));
        mapParams.put("pg",(empty(PaymentRemainingActivity.this.params.get("pg"))) ? "" : PaymentRemainingActivity.this.params.get("pg"));
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    // new PostRechargeData().execute();
                    sendUpdates();
                    PaymentRemainingActivity.this.finish();
                  //Intent intent=new Intent(PaymentRemainingActivity.this, MainActivity.class);
 ...
 /*   class PostRechargeData extends AsyncTask<String, String, String>
    ...
    public void sendUpdates(){
        ...
        progressDialog = progressDialog.show(PaymentRemainingActivity.this, "", "Please wait...", false, false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Wallet_url, new Response.Listener<String>()  {
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(PaymentRemainingActivity.this, "Please Contact Admin", Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
