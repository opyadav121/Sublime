...
public class CouponPaymentGatway extends Activity {
    ...
    static String getFirstName, getNumber, getEmailAddress, getRechargeAmt, getEmail, getCouponName,getQuantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getQuantity = oIntent.getExtras().getString("quantity");
        getCouponName = oIntent.getExtras().getString("coupon_name");
   ...
   params.put(post_val.get(i), post_val.get(i+1));
    ...
    i+=2;
        ...
        webView.setWebViewClient(new CouponPaymentGatway.MyWebViewClient() {
   ...
   public boolean shouldOverrideUrlLoading(WebView view, String url) {
    ...
    return false;
        ...
        webView.addJavascriptInterface(new CouponPaymentGatway.PayUJavaScriptInterface(), "PayUMoney");
        Map<String, String> mapParams = new HashMap<String, String>();
        mapParams.put("key", merchant_key);
        mapParams.put("hash", CouponPaymentGatway.this.hash);
        mapParams.put("txnid", (empty(CouponPaymentGatway.this.params.get("txnid"))) ? "" : CouponPaymentGatway.this.params.get("txnid"));
        Log.d(tag, "txnid: " + CouponPaymentGatway.this.params.get("txnid"));
        mapParams.put("service_provider", "payu_paisa");

        mapParams.put("amount", (empty(CouponPaymentGatway.this.params.get("amount"))) ? "" : CouponPaymentGatway.this.params.get("amount"));
        mapParams.put("firstname", (empty(CouponPaymentGatway.this.params.get("firstname"))) ? "" : CouponPaymentGatway.this.params.get("firstname"));
        mapParams.put("email", (empty(CouponPaymentGatway.this.params.get("email"))) ? "" : CouponPaymentGatway.this.params.get("email"));
        mapParams.put("phone", (empty(CouponPaymentGatway.this.params.get("phone"))) ? "" : CouponPaymentGatway.this.params.get("phone"));

        mapParams.put("productinfo", (empty(CouponPaymentGatway.this.params.get("productinfo"))) ? "" : CouponPaymentGatway.this.params.get("productinfo"));
        mapParams.put("surl", (empty(CouponPaymentGatway.this.params.get("surl"))) ? "" : CouponPaymentGatway.this.params.get("surl"));
        mapParams.put("furl", (empty(CouponPaymentGatway.this.params.get("furl"))) ? "" : CouponPaymentGatway.this.params.get("furl"));
        mapParams.put("lastname", (empty(CouponPaymentGatway.this.params.get("lastname"))) ? "" : CouponPaymentGatway.this.params.get("lastname"));

        mapParams.put("address1", (empty(CouponPaymentGatway.this.params.get("address1"))) ? "" : CouponPaymentGatway.this.params.get("address1"));
        mapParams.put("address2", (empty(CouponPaymentGatway.this.params.get("address2"))) ? "" : CouponPaymentGatway.this.params.get("address2"));
        mapParams.put("city", (empty(CouponPaymentGatway.this.params.get("city"))) ? "" : CouponPaymentGatway.this.params.get("city"));
        mapParams.put("state", (empty(CouponPaymentGatway.this.params.get("state"))) ? "" : CouponPaymentGatway.this.params.get("state"));

        mapParams.put("country", (empty(CouponPaymentGatway.this.params.get("country"))) ? "" : CouponPaymentGatway.this.params.get("country"));
        mapParams.put("zipcode", (empty(CouponPaymentGatway.this.params.get("zipcode"))) ? "" : CouponPaymentGatway.this.params.get("zipcode"));
        mapParams.put("udf1", (empty(CouponPaymentGatway.this.params.get("udf1"))) ? "" : CouponPaymentGatway.this.params.get("udf1"));
        mapParams.put("udf2", (empty(CouponPaymentGatway.this.params.get("udf2"))) ? "" : CouponPaymentGatway.this.params.get("udf2"));

        mapParams.put("udf3", (empty(CouponPaymentGatway.this.params.get("udf3"))) ? "" : CouponPaymentGatway.this.params.get("udf3"));
        mapParams.put("udf4", (empty(CouponPaymentGatway.this.params.get("udf4"))) ? "" : CouponPaymentGatway.this.params.get("udf4"));
        mapParams.put("udf5", (empty(CouponPaymentGatway.this.params.get("udf5"))) ? "" : CouponPaymentGatway.this.params.get("udf5"));
        mapParams.put("pg", (empty(CouponPaymentGatway.this.params.get("pg"))) ? "" : CouponPaymentGatway.this.params.get("pg"));
  ...
  /*public class PayUJavaScriptInterface {
   ...
   @JavascriptInterface
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    // new PostRechargeData().execute();
                    Purchase();
                    Intent intent = new Intent(CouponPaymentGatway.this, MainActivity.class);
    ...
    public void Purchase(){
        ...
        String Wallet_url= Constants.Application_URL+"/users/index.php/payment/success_coupon_payu";
        progressDialog = progressDialog.show(CouponPaymentGatway.this, "", "Please wait...", false, false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Wallet_url, new Response.Listener<String>()  {
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(CouponPaymentGatway.this, "Please Contact Admin", Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("amount",getRechargeAmt);
                params.put("pay_amount", getRechargeAmt);
                params.put("quantity",getQuantity);
                params.put("coupon_name", getCouponName);
                return params;
            }
        };
