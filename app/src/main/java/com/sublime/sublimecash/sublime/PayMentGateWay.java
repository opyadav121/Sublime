...
public class PayMentGateWay extends Activity {
 ...
 /*   class PostRechargeData extends AsyncTask<String, String, String>
    ...
    public void sendUpdates(){
        ...
        progressDialog = progressDialog.show(PayMentGateWay.this, "", "Please wait...", false, false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Wallet_url, new Response.Listener<String>()  {
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(PayMentGateWay.this, "Please Contact Admin", Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
