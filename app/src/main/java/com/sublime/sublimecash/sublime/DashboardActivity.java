...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doj.setText(myProfile.ActivationDate);
        int teamSize = Integer.parseInt(myProfile.total_left_user) + Integer.parseInt(myProfile.total_right_user);
        txtTeamSize.setText(Integer.toString(teamSize));
    }
    public void Slider1(){
